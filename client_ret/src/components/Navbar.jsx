  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      ...
      <ul className="text-white md:flex hidden list-none flex-row justify-between items-center flex-initial">
        ...
        <a href="http://localhost:3000/" class="mx-4 cursor-pointer undefined">New Purchase</a>
        <a href="http://localhost:4000/" class="mx-4 cursor-pointer undefined">Retrieve</a>
        <a href="http://localhost:5000/" class="mx-4 cursor-pointer undefined">Digital Gold</a>
